...
import { FlareTextMessage } from "@flare-im/vue-ui/components";
import { FlareImageMessage } from "@flare-im/vue-ui/components";
import { FlareVideoMessage } from "@flare-im/vue-ui/components";
import { FlareVoiceMessage } from "@flare-im/vue-ui/components";
import { FlareFileMessage } from "@flare-im/vue-ui/components";
import { FlareLocationMessage } from "@flare-im/vue-ui/components";
import { FlareContactMessage } from "@flare-im/vue-ui/components";
import { FlareLinkCardMessage } from "@flare-im/vue-ui/components";
import { FlareVoteMessage } from "@flare-im/vue-ui/components";
import { FlareTaskMessage } from "@flare-im/vue-ui/components";
import { FlareStickerMessage } from "@flare-im/vue-ui/components";
import { FlareEmojiMessage } from "@flare-im/vue-ui/components";
import { FlareSystemMessage } from "@flare-im/vue-ui/components";
...
import { FlareMessageContentView as ContentView } from "@flare-im/vue-ui/components";
import DemoStage from "./DemoStage.vue";
import { defineComponent, h } from "vue";
import { useFlareNotificationProvider } from "@flare-im/vue-ui/composables";
...
// Business types render the contract body (checkbox + title + meta for a task)
// inside the card surface, with the detail rows underneath — the same shape the
// native dispatchers use.
const taskContent = {
  contentType: "task",
  data: { title: "整理评审结论并同步", subtitle: "今天 18:00 截止", status: "done", assignee: "Ivy Chen", dueTime: "今天 18:00" },
};
</script>
...
<template>
  ...
  <div class="canvas">
    ...
    <div class="item"><span class="tag">task · FlareTaskMessage</span>
      <ContentView :content="taskContent" />
    </div>
  </div>
  </DemoStage>
</template>
