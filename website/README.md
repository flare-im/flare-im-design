...
```bash
npm install
node tooling/gen-components.mjs   # (re)generate website/components/*.md from the spec
...
- **API tables & code tabs** — emitted by `tooling/gen-components.mjs` straight from the
