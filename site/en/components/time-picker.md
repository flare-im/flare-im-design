...
> TimePicker — adaptive: an anchored popover (hour/minute columns) on PC, a bottom sheet on App/H5; v-model as "HH:mm".

## Preview

Both forms shown side by side: open on the left (PC) for a dropdown panel, open inside the phone frame on the right for a bottom sheet clipped to the device.
...
<div class="flare-platform-grid">
  <div class="flare-platform-card"><h4>Vue</h4><div><code>FlareTimePicker</code></div><div style="color:var(--vp-c-text-3);font-size:12px;margin-top:4px">@flare-im/vue-ui</div></div>
