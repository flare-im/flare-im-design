...
|---|---|:---:|---|---|
| `contact` | `Contact` | ✔ | — | The contact to profile. |
...
<span class="flare-tag">message</span> <span class="flare-tag">call</span> <span class="flare-tag">video</span> <span class="flare-tag">edit</span> <span class="flare-tag">remove</span> <span class="flare-tag">block</span>

## Platform implementations

<div class="flare-platform-grid">
  <div class="flare-platform-card"><h4>Vue</h4><div><code>FlareContactDetail</code></div><div style="color:var(--vp-c-text-3);font-size:12px;margin-top:4px">flare-core-vue-im-ui</div></div>
  ...
  <div class="flare-platform-card"><h4>iOS</h4><div><code>ContactDetailView</code></div><div style="color:var(--vp-c-text-3);font-size:12px;margin-top:4px">FlareIMUI</div></div>
...
```vue [Vue]
<script setup>
import { FlareContactDetail } from "flare-core-vue-im-ui";
</script>
<template>
  <FlareContactDetail
  :contact="contact"
