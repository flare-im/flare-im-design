...
<div class="flare-platform-grid">
  <div class="flare-platform-card"><h4>Vue</h4><div><code>FlareEmptyState</code></div><div style="color:var(--vp-c-text-3);font-size:12px;margin-top:4px">flare-core-vue-im-ui</div></div>
...
```vue [Vue]
<script setup>
import { FlareEmptyState } from "flare-core-vue-im-ui";
</script>
<template>
  <FlareEmptyState
  :title="title"
