...
.markdown-preview__body :deep(blockquote) {
  padding: 6px 10px;
  border-left: 3px solid color-mix(in srgb, var(--im-primary, var(--flare-color-primary, #7047D6)) 46%, transparent);
  border-radius: 0 7px 7px 0;
  color: var(--im-text-secondary);
  background: color-mix(in srgb, var(--im-primary, var(--flare-color-primary, #7047D6)) 6%, var(--im-bg-surface-alt, #f4f6fb));
}
...
.markdown-preview__body :deep(code) {
  ...
  border-radius: 5px;
  color: color-mix(in srgb, var(--im-primary, var(--flare-color-primary, #7047D6)) 76%, var(--im-text-primary));
  background: color-mix(in srgb, var(--im-primary, var(--flare-color-primary, #7047D6)) 7%, var(--im-bg-surface-alt, #f4f6fb));
  font-size: 0.92em;
}
...
.markdown-preview__body :deep(img) {
  ...
  margin: 8px 0;
  border: 1px solid color-mix(in srgb, var(--im-border, var(--flare-color-border-hover, #C9CDD7)) 54%, transparent);
  border-radius: 8px;
  object-fit: cover;
}
...
.markdown-preview__body :deep(td) {
  padding: 5px 7px;
  border: 1px solid color-mix(in srgb, var(--im-border, var(--flare-color-border-hover, #C9CDD7)) 70%, transparent);
}
