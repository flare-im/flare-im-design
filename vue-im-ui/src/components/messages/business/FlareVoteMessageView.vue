...
.business-vote-option__bar {
  ...
  overflow: hidden;
  border-radius: 999px;
  background: color-mix(in srgb, var(--im-primary, var(--flare-color-primary, #7047D6)) 8%, var(--im-bg-surface-alt, #f4f6fb));
}
...
.business-vote-option__bar::before {
  ...
  background: color-mix(in srgb, var(--im-primary, var(--flare-color-primary, #7047D6)) 72%, var(--im-text-primary, #111827));
  content: "";
