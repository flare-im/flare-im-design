...
.business-detail-block__row {
  ...
  align-items: start;
  padding: 8px 9px;
  border-top: 1px solid color-mix(in srgb, var(--im-border, var(--flare-color-border-hover, #C9CDD7)) 30%, transparent);
}
...
.business-detail-block__footer {
  ...
  overflow: hidden;
  border-top: 1px solid color-mix(in srgb, var(--im-border, var(--flare-color-border-hover, #C9CDD7)) 56%, transparent);
...
.business-detail-block__toggle {
  flex: 0 0 auto;
  border-right: 1px solid color-mix(in srgb, var(--im-border, var(--flare-color-border-hover, #C9CDD7)) 46%, transparent);
}

.business-detail-block__action {
  flex: 1 1 auto;
  justify-content: flex-end;
  color: color-mix(in srgb, var(--im-primary, var(--flare-color-primary, #7047D6)) 88%, var(--im-text-primary, #111827));
}
...
.business-detail-block__action:focus-visible {
  background: color-mix(in srgb, var(--im-primary, var(--flare-color-primary, #7047D6)) 6%, transparent);
  outline: none;
}
