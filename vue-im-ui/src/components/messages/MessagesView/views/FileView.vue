...
.im-file__type-icon {
  ...
  width: 42px;
  height: 42px;
  border: 1px solid color-mix(in srgb, var(--im-brand-primary, var(--flare-color-primary, #7047D6)) 20%, transparent);
  border-radius: 12px;
  color: var(--im-brand-primary, var(--flare-color-primary, #7047D6));
  background: color-mix(in srgb, var(--im-brand-primary, var(--flare-color-primary, #7047D6)) 12%, var(--im-bg-surface-alt, #f4f6fb));
}
...
.im-file__action {
  ...
  border-radius: 12px;
  color: var(--im-brand-primary, var(--flare-color-primary, #7047D6));
  background: color-mix(in srgb, var(--im-brand-primary, var(--flare-color-primary, #7047D6)) 12%, transparent);
  cursor: pointer;
  transition:
...
.im-file__action:focus-visible {
  background: color-mix(in srgb, var(--im-brand-primary, var(--flare-color-primary, #7047D6)) 18%, transparent);
