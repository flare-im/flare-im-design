...
.im-image-group__grid {
  ...
  padding: 6px;
  border-radius: 14px;
  background: color-mix(in srgb, var(--im-bg-surface-alt, var(--flare-color-bg-tertiary, #F1F2F5)) 92%, #ffffff 8%);
...
.im-image-group__cell {
  ...
  min-height: 96px;
  border-radius: 10px;
  background: color-mix(in srgb, var(--im-bg-surface, var(--flare-color-bg-primary, #ffffff)) 82%, var(--im-bg-surface-alt, var(--flare-color-bg-tertiary, #F1F2F5)));
