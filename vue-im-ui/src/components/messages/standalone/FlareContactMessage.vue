...
<style scoped>
.fm-contact { display: inline-flex; align-items: center; gap: 12px; min-width: 240px; padding: 9px 14px; border-radius: 16px 16px 16px 4px; background: var(--im-bg-surface, #fff); border: 1px solid var(--im-border-subtle, var(--flare-color-border-secondary, #ECEEF2)); box-shadow: var(--im-bubble-shadow, 0 2px 10px rgba(0,0,0,.05)); cursor: pointer; }
...
.meta b { font-size: 15px; font-weight: 600; color: var(--im-text-primary, var(--flare-color-text-primary, #20232D)); }
.meta small { font-size: 11px; color: var(--im-text-tertiary, var(--flare-color-text-tertiary, #687182)); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.chev { color: var(--im-text-tertiary, var(--flare-color-text-tertiary, #687182)); }
</style>
