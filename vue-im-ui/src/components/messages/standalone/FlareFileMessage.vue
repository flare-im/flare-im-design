...
<style scoped>
.fm-file { display: inline-flex; align-items: center; gap: 10px; max-width: 300px; padding: 9px 14px; border-radius: 16px 16px 16px 4px; background: var(--im-bg-surface, #fff); border: 1px solid var(--im-border-subtle, var(--flare-color-border-secondary, #ECEEF2)); box-shadow: var(--im-bubble-shadow, 0 2px 10px rgba(0,0,0,.05)); cursor: pointer; }
.ic { color: var(--im-primary, var(--flare-color-primary, #7047D6)); display: flex; }
.meta { flex: 1; min-width: 0; display: flex; flex-direction: column; }
.meta b { font-size: 14px; font-weight: 500; color: var(--im-text-primary, var(--flare-color-text-primary, #20232D)); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.meta small { font-size: 11px; color: var(--im-text-tertiary, var(--flare-color-text-tertiary, #687182)); }
.dl { flex: none; border: none; background: none; padding: 0; display: flex; color: var(--im-text-tertiary, var(--flare-color-text-tertiary, #687182)); cursor: pointer; }
</style>
