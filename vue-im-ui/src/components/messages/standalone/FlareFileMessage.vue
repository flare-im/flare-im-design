...
<style scoped>
.fm-file { display: inline-flex; align-items: center; gap: 10px; max-width: 300px; padding: 9px 14px; border-radius: 16px 16px 16px 4px; background: var(--im-bg-surface, #fff); border: 1px solid var(--im-border-subtle, var(--flare-color-border-secondary, #eef0f4)); box-shadow: var(--im-bubble-shadow, 0 2px 10px rgba(0,0,0,.05)); cursor: pointer; }
.ic { color: var(--im-primary, var(--flare-color-primary, #7c3aed)); display: flex; }
...
.dl { flex: none; border: none; background: none; padding: 0; display: flex; color: var(--im-text-tertiary, var(--flare-color-text-tertiary, #a3a7ae)); cursor: pointer; }
</style>
