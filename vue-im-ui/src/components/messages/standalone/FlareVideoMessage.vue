...
<style scoped>
.fm-video { padding: 0; border: none; position: relative; width: 148px; height: 92px; border-radius: 12px; overflow: hidden; background: var(--im-bg-surface-alt, var(--flare-color-bg-tertiary, #F1F2F5)); display: grid; place-items: center; cursor: pointer; }
.fm-video img { width: 100%; height: 100%; object-fit: cover; }
.ph { opacity: .5; color: var(--im-text-tertiary, var(--flare-color-text-tertiary, #687182)); }
