...
public struct UnknownUserPlaceholderView: View {
    ...
    public init(userId: String,
                ...
                deactivatedText: String? = nil,
                blockedText: String? = nil,
                unreachableText: String? = nil,
                idLabel: String? = nil,
    ...
    public var title: String {
        ...
        case .deactivated: return copy.deactivatedText
        case .blocked: return copy.blockedText
        case .unreachable: return copy.unreachableText
        case .unknown: return copy.unknownText
        }
    }
    ...
    public var accessibilityText: String {
        ...
        if !full.isEmpty { parts.append("\(copy.idLabel) \(full)") }
        return parts.joined(separator: " · ")
    }

    /// Copy in effect: an explicit parameter wins, otherwise the `flareStrings` provider.
    struct Copy {
        let unknownText, deactivatedText, blockedText, unreachableText: String
        let idLabel: String
    }
    func resolveCopy(_ strings: FlareStrings) -> Copy {
        Copy(
            unknownText: unknownText ?? strings.unknownUserPlaceholderUnknown,
            deactivatedText: deactivatedText ?? strings.unknownUserPlaceholderDeactivated,
            blockedText: blockedText ?? strings.unknownUserPlaceholderBlocked,
            unreachableText: unreachableText ?? strings.unknownUserPlaceholderUnreachable,
            idLabel: idLabel ?? strings.unknownUserPlaceholderId
        )
    }
