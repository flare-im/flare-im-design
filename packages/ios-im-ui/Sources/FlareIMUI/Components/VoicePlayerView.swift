...
public struct VoicePlayerView: View {
    ...
    private func playButton(_ colors: FlareColors) -> some View {
        Button { onToggle?() } label: {
            ZStack(alignment: .topTrailing) {
                ZStack {
                    ...
                    Image(systemName: flareIconSymbol(playing ? "pause" : "play"))
        ...
        // Named by what a tap does now: play, or pause while playing.
        .accessibilityLabel(playing ? strings.pause : strings.play)
    }
