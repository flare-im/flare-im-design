...
// The unit tests read the shared contract tables in `spec/` (theme modes, batch actions, the
// conversation-kind vocabulary). Without declaring them, Gradle calls the task up to date after a
// table changes and the tests pass without running — a green that means nothing.
tasks.withType<Test>().configureEach {
    inputs.dir(rootProject.layout.projectDirectory.dir("../../spec"))
        .withPathSensitivity(PathSensitivity.RELATIVE)
        .withPropertyName("flareSpecTables")
}
