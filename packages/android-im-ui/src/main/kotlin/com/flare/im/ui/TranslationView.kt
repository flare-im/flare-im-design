        ...
        Column(Modifier.padding(start = FlareSizes.spacing2sm)) {
            if (pending) {
                ...
                Row(
                    ...
                    Icon(flareIconVector("translate"), contentDescription = null, tint = colors.textTertiary, modifier = Modifier.size(12.dp))
                    ...
                    if (original != null) {
                        Row(
                            ...
                            Text(if (showOriginal) flareStrings().hideOriginal else flareStrings().showOriginal, color = colors.primaryText, fontSize = 11.sp)
                            Icon(flareIconVector("chevron-down"), contentDescription = null, tint = colors.primaryText,
