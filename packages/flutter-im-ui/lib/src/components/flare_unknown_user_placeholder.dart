...
FlareUnknownUserPresentation unknownUserPresentation(
  FlareUnknownUserKind? kind,
) => switch (kind) {
...
String shortenUserId(
  String? userId, [
  int maxLength = kFlareUnknownUserIdMaxLength,
]) {
