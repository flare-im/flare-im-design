...
class FlarePollComposer extends StatefulWidget {
  ...
  final void Function(String question, List<String> options, bool multiple)?
  onSubmit;
...
class _FlarePollComposerState extends State<FlarePollComposer> {
  String get _title => widget.title ?? FlareStrings.of(context).createPoll;
  String get _questionPlaceholder =>
      widget.questionPlaceholder ?? FlareStrings.of(context).pollQuestionHint;
  String get _addOptionLabel =>
      widget.addOptionLabel ?? FlareStrings.of(context).addOption;
  String get _multipleLabel =>
      widget.multipleLabel ?? FlareStrings.of(context).allowMultiple;
  String get _submitLabel =>
      widget.submitLabel ?? FlareStrings.of(context).submitPoll;
        ...
        children: [
          Row(
            children: [
              ...
              FlareIconControl(
                label: FlareStrings.of(context).cancel,
          ...
          if (_options.length < widget.maxOptions)
            GestureDetector(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.add, size: 17, color: colors.primaryText),
      ...
      child: Row(
        children: [
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                border: InputBorder.none,
                hintText:
                    widget.optionPlaceholder?.call(index + 1) ??
          ...
          if (_options.length > 2)
            FlareIconControl(
              label: FlareStrings.of(context).removeOption,
