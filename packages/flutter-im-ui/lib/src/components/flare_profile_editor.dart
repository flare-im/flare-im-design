...
class FlareProfileEditor extends StatefulWidget {
  ...
  /// Field / button copy; a gap is filled from [FlareStrings].
...
class _FlareProfileEditorState extends State<FlareProfileEditor> {
  ...
  Widget build(BuildContext context) {
    ...
    // Host copy wins; the kit fills every gap from the strings table.
    final labels = widget.labels.resolve(FlareStrings.of(context));
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(labels.nickname!, style: TextStyle(color: colors.textSecondary)),
          FlareInput(
            controller: _name,
          ...
          Text(labels.bio!, style: TextStyle(color: colors.textSecondary)),
          FlareInput(
...
class FlareProfileEditorLabels {
  ...
  /// Null takes the copy from [FlareStrings] (Chinese by default), so a host
  /// that overrides the strings table reaches this editor too.
  ...
  /// This editor's copy with every gap filled from [strings].
  FlareProfileEditorLabels resolve(FlareStrings strings) =>
      FlareProfileEditorLabels(
        ...
        cancel: cancel ?? strings.profileEditorCancel,
