...
class FlareAnnouncementBanner extends StatefulWidget {
  ...
  @override
  State<FlareAnnouncementBanner> createState() =>
      _FlareAnnouncementBannerState();
}

class _FlareAnnouncementBannerState extends State<FlareAnnouncementBanner> {
  String get _title =>
      widget.title ?? FlareStrings.of(context).groupAnnouncement;
  String get _expandLabel =>
      widget.expandLabel ?? FlareStrings.of(context).expand;
  String get _collapseLabel =>
      widget.collapseLabel ?? FlareStrings.of(context).collapse;
      ...
      child: Row(
        ...
        children: [
                ...
                if (showToggle) ...[
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          _expanded ? _collapseLabel : _expandLabel,
                          style: TextStyle(
                            color: colors.primaryText,
                            fontSize: 12,
          ...
          if (widget.dismissible)
            // The glyph keeps its corner; the rest of the target extends
            // inward and down.
            FlareIconControl(
              label: FlareStrings.of(context).close,
