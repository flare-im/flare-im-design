...
class _FlareStartConversationSheetState
  ...
  String get _searchPlaceholder =>
      ...
      FlareStrings.of(context).startConversationSheetSearchPlaceholder;
  String get _emptyText =>
      widget.emptyText ?? FlareStrings.of(context).startConversationSheetEmpty;
  String get _confirmLabel =>
      widget.confirmLabel ?? FlareStrings.of(context).confirm;
                  ...
                  child: FilledButton(
                    ...
                    child: widget.busy
                        ...
                        : Text(
                            _selected.isEmpty
                                ? _confirmLabel
                                : '${_confirmLabel} (${_selected.length})',
                          ),
                  ),
                ),
              ),
