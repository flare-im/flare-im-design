...
class FlareGroupMemberGrid extends StatelessWidget {
  ...
  /// Members in the group when [members] is a preview of the first few; the
  /// count shows this instead of the preview's length.
  final int? total;
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                memberCountText?.call(total ?? members.length) ??
                    FlareStrings.of(
                      context,
                    ).memberCount(total ?? members.length),
                style: TextStyle(
