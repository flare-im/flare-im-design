...
class FlareConversationDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Center(
          child: Column(
            children: [
              ...
              if (c.kind == FlareConversationKind.group &&
                  c.memberCount != null)
                Text(
        ...
        if (onArchive != null)
          _actionRow(
            c.archived ? labels.unarchive : labels.archive,
            flareIconGlyph(c.archived ? 'unarchive' : 'archive'),
            onArchive!,
            colors,
          ),
  ...
  Color _statusToneColor(FlareColors colors, FlareStatusTone tone) {
    switch (tone) {
  ...
  Widget _actionRow(
    ...
    return ListTile(
      leading: Icon(
        icon,
        color: danger ? colors.errorText : colors.textSecondary,
      ),
      title: Text(
        label,
