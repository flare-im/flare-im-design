...
<template>
  <div class="flare-announcement">
    <span class="flare-announcement__icon"><n-icon aria-hidden="true" :size="16" :component="MegaphoneOutline" /></span>
    <div class="flare-announcement__body">
      ...
      >
        ...
        <n-icon aria-hidden="true" :size="13" :component="ChevronDownOutline" :class="{ 'is-up': expanded }" />
      </button>
    </div>
    <button
      v-if="dismissible"
...
.flare-announcement {
  ...
  border: 1px solid color-mix(in srgb, var(--flare-color-primary) 22%, transparent);
}
