...
.markdown-preview__body :deep(blockquote) {
  ...
  background: color-mix(in srgb, var(--flare-color-primary) 6%, var(--flare-color-bg-tertiary));
}
...
.markdown-preview__body :deep(code) {
  ...
  border-radius: 5px;
  color: color-mix(in srgb, var(--flare-color-primary-text) 76%, var(--flare-color-text-primary));
  background: color-mix(in srgb, var(--flare-color-primary) 7%, var(--flare-color-bg-tertiary));
  font-size: 0.92em;
}
...
.markdown-preview__body :deep(td) {
  padding: 5px 7px;
  border: 1px solid color-mix(in srgb, var(--flare-color-border-primary) 70%, transparent);
}

.markdown-preview__body :deep(th) {
  background: color-mix(in srgb, var(--flare-color-bg-tertiary) 74%, var(--flare-color-bg-primary));
  font-weight: 700;
}
