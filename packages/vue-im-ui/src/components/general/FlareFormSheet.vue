...
import FlareBottomSheet, { type FlareSheetPresentation } from "./FlareBottomSheet.vue";
...
.flare-form-sheet__error { margin: 0; color: var(--flare-color-error-text); font-size: var(--flare-size-font-size-sm); }
</style>
