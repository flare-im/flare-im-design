...
<template>
  <div class="flare-emoji-picker">
    <div class="flare-emoji-picker__search">
      <n-icon aria-hidden="true" :size="15" :component="SearchOutline" class="flare-emoji-picker__search-ico" />
    ...
    <div v-if="!query" class="flare-emoji-picker__rail" role="tablist">
      ...
      >
        <n-icon aria-hidden="true" v-if="c.key === '__recent'" :size="16" :component="TimeOutline" />
...
.flare-emoji-picker__input:focus-visible { outline: 2px solid var(--flare-color-border-selected); outline-offset: -2px; border-radius: var(--flare-size-radius-sm); }
...
.flare-emoji-picker__tone.is-active { opacity: 1; background: var(--flare-color-bg-selected); }
...
.flare-emoji-picker__emoji:hover { background: var(--flare-color-bg-secondary); transform: scale(1.12); }
...
.flare-emoji-picker__tab.is-active { background: var(--flare-color-bg-selected); }
</style>
