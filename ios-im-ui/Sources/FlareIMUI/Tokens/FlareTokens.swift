...
public struct FlareColors: Sendable {
    ...
    public static let light = FlareColors(
        bgDisabled: Color(.sRGB, red: 0.9490, green: 0.9529, blue: 0.9608, opacity: 1.0),
        bgHover: Color(.sRGB, red: 0.9333, green: 0.9451, blue: 0.9647, opacity: 1.0),
        bgPrimary: Color(.sRGB, red: 1.0000, green: 1.0000, blue: 1.0000, opacity: 1.0),
        bgSecondary: Color(.sRGB, red: 0.9608, green: 0.9647, blue: 0.9725, opacity: 1.0),
        bgSelected: Color(.sRGB, red: 0.9451, green: 0.9176, blue: 1.0000, opacity: 1.0),
        bgTertiary: Color(.sRGB, red: 0.9490, green: 0.9529, blue: 0.9608, opacity: 1.0),
        borderHover: Color(.sRGB, red: 0.8431, green: 0.8588, blue: 0.8902, opacity: 1.0),
        borderPrimary: Color(.sRGB, red: 0.9059, green: 0.9137, blue: 0.9333, opacity: 1.0),
        borderSecondary: Color(.sRGB, red: 0.9333, green: 0.9412, blue: 0.9569, opacity: 1.0),
        ...
        bubbleSystem: Color(.sRGB, red: 0.9490, green: 0.9529, blue: 0.9608, opacity: 1.0),
        ...
        textDisabled: Color(.sRGB, red: 0.7882, green: 0.8039, blue: 0.8314, opacity: 1.0),
        ...
        textPrimary: Color(.sRGB, red: 0.0667, green: 0.0745, blue: 0.0941, opacity: 1.0),
        textSecondary: Color(.sRGB, red: 0.4196, green: 0.4471, blue: 0.5020, opacity: 1.0),
        textTertiary: Color(.sRGB, red: 0.6392, green: 0.6549, blue: 0.6824, opacity: 1.0),
    ...
    public static let dark = FlareColors(
        ...
        bgPrimary: Color(.sRGB, red: 0.1020, green: 0.1137, blue: 0.1373, opacity: 1.0),
        bgSecondary: Color(.sRGB, red: 0.0667, green: 0.0745, blue: 0.0941, opacity: 1.0),
        bgSelected: Color(.sRGB, red: 0.4863, green: 0.2275, blue: 0.9294, opacity: 0.2000),
        bgTertiary: Color(.sRGB, red: 0.1333, green: 0.1490, blue: 0.1804, opacity: 1.0),
        borderHover: Color(.sRGB, red: 0.8431, green: 0.8588, blue: 0.8902, opacity: 1.0),
...
public enum FlareSizes {
    ...
    public static let radiusLg: CGFloat = 8.0
    public static let radiusMd: CGFloat = 6.0
    public static let radiusSm: CGFloat = 4.0
    public static let radiusXl: CGFloat = 12.0
    public static let radiusXs: CGFloat = 2.0
