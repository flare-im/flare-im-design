...
public struct FlareColors: Sendable {
    ...
    public static let light = FlareColors(
        ...
        bubbleOther: Color(.sRGB, red: 1.0000, green: 1.0000, blue: 1.0000, opacity: 1.0),
        bubbleRobot: Color(.sRGB, red: 0.9451, green: 0.9490, blue: 0.9608, opacity: 1.0),
        bubbleSelf: Color(.sRGB, red: 0.4392, green: 0.2784, blue: 0.8392, opacity: 1.0),
        bubbleSystem: Color(.sRGB, red: 0.9451, green: 0.9490, blue: 0.9608, opacity: 1.0),
        error: Color(.sRGB, red: 0.9373, green: 0.2667, blue: 0.2667, opacity: 1.0),
        focusRing: Color(.sRGB, red: 0.4392, green: 0.2784, blue: 0.8392, opacity: 0.3500),
        ...
        pinned: Color(.sRGB, red: 0.4392, green: 0.2784, blue: 0.8392, opacity: 1.0),
        primary: Color(.sRGB, red: 0.4392, green: 0.2784, blue: 0.8392, opacity: 1.0),
        primaryActive: Color(.sRGB, red: 0.3176, green: 0.1725, blue: 0.6745, opacity: 1.0),
        primaryHover: Color(.sRGB, red: 0.3804, green: 0.2196, blue: 0.7686, opacity: 1.0),
        ...
        textLink: Color(.sRGB, red: 0.4392, green: 0.2784, blue: 0.8392, opacity: 1.0),
        textLinkHover: Color(.sRGB, red: 0.3804, green: 0.2196, blue: 0.7686, opacity: 1.0),
        textPrimary: Color(.sRGB, red: 0.1255, green: 0.1373, blue: 0.1765, opacity: 1.0),
        textSecondary: Color(.sRGB, red: 0.3843, green: 0.4118, blue: 0.4706, opacity: 1.0),
        textTertiary: Color(.sRGB, red: 0.4078, green: 0.4431, blue: 0.5098, opacity: 1.0),
    ...
    public static let dark = FlareColors(
        ...
        bubbleOther: Color(.sRGB, red: 0.1255, green: 0.1373, blue: 0.1686, opacity: 1.0),
        bubbleRobot: Color(.sRGB, red: 0.1608, green: 0.1765, blue: 0.2157, opacity: 1.0),
        bubbleSelf: Color(.sRGB, red: 0.4392, green: 0.2784, blue: 0.8392, opacity: 1.0),
        bubbleSystem: Color(.sRGB, red: 0.1608, green: 0.1765, blue: 0.2157, opacity: 1.0),
        error: Color(.sRGB, red: 0.9373, green: 0.2667, blue: 0.2667, opacity: 1.0),
...
public enum FlareSizes {
    ...
    public static let leftPanel: CGFloat = 320.0
    public static let rightPanel: CGFloat = 300.0
    public static let sessionItemHeight: CGFloat = 72.0
    public static let dualPaneMinWidth: CGFloat = 720.0
    public static let triplePaneMinWidth: CGFloat = 1100.0
